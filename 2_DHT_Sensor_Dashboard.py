...
REFRESH_INTERVAL = 30  # Seconds between data refreshes (adjusted for production use)
...
def main():
    ...
    **About Time Display:**
    ...
    The year may show as 2025 due to system clock issues, but the time conversion is correct.
    """)
    ...
    # Manual refresh button instead of automatic refresh
